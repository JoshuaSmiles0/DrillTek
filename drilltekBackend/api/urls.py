...
urlpatterns = [
    ...
    # Drillprogram related endpoints
    ...
    path('drillProgram/deleteProgram', DrillProgramViewSet.as_view({'delete': 'deleteProgram'}), name='deleteProgram'),
    # Drillhole related endpoints
    ...
    path('drillhole/deleteDrillhole', DrillholeViewSet.as_view({'delete':'deleteDrillhole'}), name='deleteDrillhole'),
    # Protected user endpoints
    path('user/getEmail', ProtectedUserViewset.as_view({'get':'getUserEmailById'}), name='getUserEmailById'),
    # Lithlog related endpoints
    ...
    # Alteration log related endpoints
    ...
    # Structure log related endpoints
